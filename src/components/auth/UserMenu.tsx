/**
 * @file UserMenu.tsx
 * @description Avatar trigger that opens a profile popover rendered in a Portal.
 */
      ...
      {mounted &&
        ...
        createPortal(
          <div
            ref={menuRef}
            role="menu"
            className="fixed z-[9999] w-72 overflow-hidden rounded-2xl"
            style={{
              top: position.top,
              left: position.left,
          ...
          >
            ...
            <div className="flex items-center gap-3.5 px-4 py-4">
              <div
                ...
                style={{
                  boxShadow: "0 0 0 2px oklch(0.74 0.16 158 / 0.35)",
                }}
              >
                {user.photoURL ? (
                  <img
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, oklch(0.74 0.16 158), oklch(0.62 0.16 158))",
                      color: "oklch(0.15 0.01 240)",
                    }}
                  >
                    {initials}
                ...
                <div className="mt-1.5">
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: "oklch(0.74 0.16 158)",
                      }}
                    />
                    Synced
                  </span>
            ...
            <div className="p-2">
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "oklch(0.65 0.21 28 / 0.08)";
                  e.currentTarget.style.color = "oklch(0.65 0.21 28)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "transparent";
                  e.currentTarget.style.color = "oklch(0.62 0.012 240)";
                }}
              >
                <svg
                  viewBox="0 0 24 24"
