  ...
  head: () => ({
    meta: [
      { title: "Habito — Daily Habit Tracker" },
      {
        name: "description",
        content:
          "Track your daily habits, measure streaks, and build consistency with Habito — a beautiful, privacy-first habit tracker.",
      },
      ...
      { property: "og:title", content: "Habito — Daily Habit Tracker" },
      {
        ...
        content:
          "Build lasting habits with Habito. Track streaks, measure progress, and stay consistent every day.",
      },
